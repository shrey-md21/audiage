...
import sys
# fraction = 0.2  # Adjust this value according to your needs
...
get_music(prompt=sys.argv[1], musicAI_indx=0, duration=6)
# display(Audio('audio.mp3', autoplay=True))
#get_music(prompt="Astronaut riding a bike", musicAI_indx=0, duration=6)